...
class Persona(models.Model):
    ...
    apellidoPaterno = models.CharField(max_length = 20, null= True, blank=True)
    apellidoMaterno = models.CharField(max_length = 20, null= True, blank=True)
...
class Producto(models.Model):
    ...
    fVenc = models.DateField(auto_now=False, auto_now_add=False, null=True, blank=True)
    idFamProducto = models.ForeignKey(FamiliaProducto, on_delete=models.CASCADE)
